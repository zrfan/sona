...
#cp -r ./dist/target/sona-0.1.1-bin/lib   /data10/home/weibo_bigdata_push/zhongrui3/rsync/sona/sona-0.1.1-bin/
#
#
...
hdfs dfs -rm -r zhongrui3/depend/sona-0.1.1-bin/lib
hdfs dfs -put ./dist/target/sona-0.1.1-bin/lib  zhongrui3/depend/sona-0.1.1-bin/